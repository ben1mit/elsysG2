...
#define HTTP2_SERVER_URI "https://www.vibecheck.no/esptest.php" //"https://http2.golang.org"
...
{
#define DATA_TO_SEND "{'id': 1, 'data': [2,3,4], 'turbine_id': 3}" //'{"id": 1, "data": [2,3,4], "turbine_id": 3}' //"Hello World"
